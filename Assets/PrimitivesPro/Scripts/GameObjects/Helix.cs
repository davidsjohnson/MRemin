...
namespace PrimitivesPro.GameObjects
{
    ...
    public class Helix : BaseObject
    {
        ...
        {
            GenerateGeometry(radius0, radius1, height, sides, heightSegments, slice, angleRatio, radialMapping, normalsType, pivotPosition);
        ...
        public override void GenerateColliderGeometry()
        {
            ...
            if (meshCollider)
            {
                ...
                Primitives.HelixPrimitive.GenerateGeometry(meshCollider, radius0, radius1, height, sides, heightSegments, slice, angleRatio, radialMapping, normalsType, pivotPosition);
        ...
        public override System.Collections.Generic.Dictionary<string, object> LoadState(bool collision)
        {
            ...
            angleRatio = (float)dic["angleRatio"];
